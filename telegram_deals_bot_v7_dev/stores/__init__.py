from stores.noon_minutes import NoonMinutesConnector
...
from stores.raneen import RaneenConnector
from stores.kenzz import KenzzConnector
...
CONNECTORS = {
    ...
    "kenzz": KenzzConnector,
    "noon_minutes": NoonMinutesConnector,
}
