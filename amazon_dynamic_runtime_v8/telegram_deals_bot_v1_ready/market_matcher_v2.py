...
DB_PATH = os.getenv("MARKET_MATCH_DB_PATH", "deals.db")
...
def _load_rows():
    ...
    # A production DB may be mounted read-only for matching. This lets the
    # isolated Amazon runtime use fresh Jumia/2B observations without writing
    # to the production database.
    if os.getenv("MARKET_MATCH_DB_PATH"):
